            ...
            <div className="space-y-4">
              ...
              >
                <div className="relative aspect-[3/4] w-full overflow-hidden rounded-lg mb-3 bg-muted">
                  {magazines[0].cover_image_url ? (
                    <img 
                      src={magazines[0].cover_image_url}
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <span className="text-white text-sm font-medium">Open E‑Magazine</span>
                  </div>
                </div>
                <div className="space-y-1">
                  ...
                  {magazines[0].issue && (
                    <p className="text-xs text-muted-foreground">{magazines[0].issue}</p>
                  )}
                </div>
              </div>
